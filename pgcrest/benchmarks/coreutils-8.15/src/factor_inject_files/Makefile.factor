...
mycp:
	cp -f ../lib/cfg cfg
	cp -f ../lib/cfg_func_map cfg_func_map
	cp -f ../lib/branches branches
	cp -f ../lib/idcount idcount
	cp -f ../lib/funcount funcount
	cp -f ../lib/stmtcount stmtcount
run:	
	../../../bin/reachability
	../../../bin/run_crest "./$(CREST_PROGRAM) 1" 1000 -path 2>$(CREST_PROGRAM)_path
