...
{
  int* __CREST_p19= (int*)malloc(sizeof(int)*10);
  addToArray((void**)&__CREST_p19,19);
...
{
  int* __CREST_p20= (int*)malloc(sizeof(int)*10);
  //addToArray((void**)&__CREST_p20,20);
  struct E_string es;
...
{
  int* __CREST_p21= (int*)malloc(sizeof(int)*10);
  addToArray((void**)&__CREST_p21,21);
  int b, c;
