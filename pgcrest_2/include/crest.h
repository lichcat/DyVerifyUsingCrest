...
EXTERN void __CrestNoop();  /* for end scope tag */
...
EXTERN void __DyVerifyAllocNoop(__CREST_ID) __SKIP;

EXTERN void __DyVerifyFree(__CREST_ID, __CREST_ADDR) __SKIP;

EXTERN void __DyVerifyLiveMemory(__CREST_ID, __CREST_ADDR) __SKIP;
EXTERN void __DyVerifyStaticPathEnd(__CREST_ID, __CREST_ID) __SKIP;
EXTERN void __StaticPathMark(__CREST_ID,__CREST_ID,__CREST_ID) __SKIP;

EXTERN void __DyVerifyIsWarningMem(__CREST_ID, __CREST_ADDR, __CREST_ID) __SKIP;
